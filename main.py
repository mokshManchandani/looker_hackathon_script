...
from download_user_with_attributes import UserAttributeDownloader
...
def main():
    ...
    users_downloader = UserAttributeDownloader(config_values['Looker'])
    users_downloader.dump_users()

    mapping = {
        "user_content":"user_content.parquet"
    }
    bq_service = BigqueryService(config_values['GCP'],name_mapping=mapping)
    bq_service.create_tables()
